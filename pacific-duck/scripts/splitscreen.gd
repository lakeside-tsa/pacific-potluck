...
func _ready():
	var viewport1 = $HBoxContainer/SubViewportContainer1/SubViewport
	var viewport2 = $HBoxContainer/SubViewportContainer2/SubViewport
	...
	print("Viewport1 size: ", $HBoxContainer/SubViewportContainer1/SubViewport.size)
	print("Viewport2 size: ", $HBoxContainer/SubViewportContainer2/SubViewport.size)
	print("ready done")
